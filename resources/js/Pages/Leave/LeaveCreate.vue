                    ...
                    <form @submit.prevent="submit" class="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea 
                                ...
                                rows="3"
                                class="mt-1 block w-full rounded border-gray-300 dark:bg-gray-700 dark:border-gray-600 text-gray-950 dark:text-white focus:ring-purple-500 focus:border-purple-500 text-sm"
                                :placeholder="__('Describe the leave reason...')"
                            ></textarea>
                        ...
                        <!-- Notes -->
                        <div>
                            <InputLabel for="notes" :value="__('Admin Approval Remarks / Remarks')" />
                            <textarea 
                                id="notes"
                                v-model="form.notes"
                                rows="2"
                                class="mt-1 block w-full rounded border-gray-300 dark:bg-gray-700 dark:border-gray-600 text-gray-950 dark:text-white focus:ring-purple-500 focus:border-purple-500 text-sm"
                                :placeholder="__('Add notes or remarks here...')"
                            ></textarea>
                        ...
                        <!-- Attachment -->
                        <div>
                            <InputLabel for="attachment" :value="__('Attach Supporting Document (Optional)')" />
                            <input 
                                id="attachment"
                                type="file"
                        ...
                        <div class="flex justify-end gap-2 border-t border-gray-200 dark:border-gray-700 pt-4">
                            <SecondaryButton @click="$inertia.visit(route('leaves.index'))">
                                {{ __('Cancel') }}
                            </SecondaryButton>
